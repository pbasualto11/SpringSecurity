...
<html lang="zxx">
   <head>
      <title>Laser Airlines - Servicio Premium</title>
      <!--meta tags -->
      <meta charset="UTF-8">
   ...
   <body>
      <!--navbar-->
      <jsp:include page="/WEB-INF/views/shared/navbarlogout.jsp" flush="true"/>
      <!--//navbar-->
      <!-- banner -->
      ...
      <div class="service-inn" id="services-inn">
         <div class="container">
            <h3 class="title">Servicio Premium</h3>
            <div class="ser-grid-three">
               <div class="col-md-6  col-sm-6 col-xs-6 service-num-info">
                  <div class="white-shadow">
                     ...
                     <div class="col-md-9 col-sm-9 col-xs-9 service-info-left">
                        <h4>Asiento en Primera Clase</h4>
                     </div>
               ...
               <div class="col-md-6  col-sm-6 col-xs-6 service-num-info">
                  <div class="white-shadow">
                     ...
                     <div class="col-md-9 col-sm-9 col-xs-9 service-info-left">
                        <h4>Sala de Espera Exclusiva</h4>
                     </div>
                     <div class="clearfix"> </div>
                  </div>
               </div>
               <div class="col-md-6  col-sm-6 col-xs-6  service-num-info">
                  <div class="white-shadow">
                     ...
                     <div class="col-md-9 col-sm-9 col-xs-9 service-info-left">
                        <h4>Fila Exclusiva de ingreso al Avión</h4>
                     </div>
                     <div class="clearfix"> </div>
                  </div>
               </div>
