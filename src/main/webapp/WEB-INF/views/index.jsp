...
<html lang="es-cl">
   ...
   <body>
                  ...
                  <div class="slider-img w3-oneimg">
                     <div class="container">
                        <div class="slider-info">
                           <h6>La</h6>
                           <h4>Línea Aérea <br>Internacional</h4>
                           <p>Quis autem vel eum iure reprehderit.Etiam sed odio consequat
                              tristique elit sed, molestie nulla.
               ...
               <li>
                  <div class="slider-img w3-threeimg">
                     <div class="container">
                        <div class="slider-info">
                           <h6>Entregando</h6>
                           <h4>Seguridad en<br> Transporte</h4>
                           <p>Quis autem vel eum iure reprehderit.Etiam sed odio consequat
                              tristique elit sed, molestie nulla.
                              velit sagittis vehicula. Duis posuere
                           </p>
      ...
      <div class="about" id="about">
         <div class="container">
            ...
            <div class=" col-md-6 about-info-air">
               <div class="air-list">
                  <h4>Bodegas y Almacenamiento</h4>
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                     Etiam sed odio consequat, tristique elit sed, molestie nulla.
            ...
            <div class="agileits-banner-grids text-center">
               <div class=" col-md-4 col-sm-4 priceing-tag">
                  <div class=" clr1 agileits-banner-grid">
                     ...
                     <div class="table_cost">
                        <span class="cost clr-price"> 500$</span>
                     </div>
                     <div class="list-price">
                        <ul>
                           <li>Asiento reservado</li>
                           <li>Equipaje hasta 50 kg</li>
               ...
               <div class="col-md-4 col-sm-4 priceing-tag">
                  <div class="clr2 agileits-banner-grid">
                     ...
                     <div class="list-price">
                        <ul>
                           <li>Asiento Primera Clase</li>
                           <li>Equipaje hasta 80 kg</li>
                           <li>Sala de Espera en Aeropuerto</li>
                           <li>Fila Exclusiva</li>
                        </ul>
                     </div>
                     <a class="w3_play_icon1" href="#" data-toggle="modal" data-target="#myModal"> Buy Now</a>
                  </div>
      ...
      <div class="testimonials colo" id="testimonials">
         <div class="container">
            <h3 class="title clr">Testimonios</h3>
      ...
      <div class="parnters" id="parnters">
         <div class="container">
            <h3 class="title clr">Nuestros Colaboradores</h3>
